...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        ParkingLots parkingLot = ParkingLots.INSTANCE;
        ...
        Console.WriteLine(ParkingLots.INSTANCE.isParkingSpaceAvailable(VehicleType.CAR));
        //Test Case 2 - check for availability of parking space for Bike - TRUE
        Console.WriteLine(ParkingLots.INSTANCE.isParkingSpaceAvailable(VehicleType.BIKE));
        //Test Case 3 - check for availability of parking space for Truck - FALSE
        Console.WriteLine(ParkingLots.INSTANCE.isParkingSpaceAvailable(VehicleType.TRUCK));
        //Test Case 4 - Entry Gate
        Console.WriteLine(ParkingLots.INSTANCE.getEntries().Count());
        ...
        Vehicle v2 = new BikeVehicle("GHFD3452");
        Ticket ticket2 = entry2.generateTicket(v2);

        //Test Case 9 - check for total parking space created for car
        Console.WriteLine(ParkingLots.INSTANCE.getFloorList()[0].getSpaces()[ParkingSpaceType.CarParking].Count());
